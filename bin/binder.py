        ...
        for line in sfile:
            ...
            # @enum
                ...
                if line == "{":
                    ...
                    enums[enum_group].append(
                        [name, f"{class_name}::{enum_group}::{name}"]
                    )
...
def compose_class_binding(binding: dict[str, list], lines: list[str]):
...
def compose_enums(enums: dict[list], lines: list[str]):
...
def compose_structs(structs: Structs, lines: list[str]):
    """
